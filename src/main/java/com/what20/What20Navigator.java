...
public class What20Navigator extends Navigator {

    // Provide a Google Analytics tracker id here
    private static final String TRACKER_ID = null;// "UA-658457-6";
    private GoogleAnalyticsTracker tracker;

    private static final What20ViewType ERROR_VIEW = What20ViewType.DASHBOARD;
    private ViewProvider errorViewProvider;

    public What20Navigator(final ComponentContainer container) {
    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(final ViewChangeEvent event) {
                What20ViewType view = What20ViewType.getByViewName(event
                        .getViewName());
                // Appropriate events get fired after the view is changed.
                What20EventBus.post(new PostViewChangeEvent(view));
                What20EventBus.post(new BrowserResizeEvent());
                What20EventBus.post(new CloseOpenWindowsEvent());
    ...
    private void initViewProviders() {
        ...
        for (final What20ViewType viewType : What20ViewType.values()) {
